...
import {
  calculateDuration,
  removeReservation,
} from 'apps/booking-app/store/reservationSlice';
import {
...
const steps = ['Twój wybór', 'Twoje dane', 'Ostatni krok'];
...
export function Reservation(props: ReservationProps) {
  ...
  const [confirmEmailError, setConfirmEmailError] =
  ...
  const validateData = () => {
    ...
    if (
      validateConfirmEmail(reservationData.email, reservationData.emailConfirm)
    ) {
      setConfirmEmailError(false);
    } else {
      setConfirmEmailError(true);
  ...
  React.useEffect(() => {
    setDuration(
      calculateDuration(reservation.checkInDate, reservation.checkOutDate)
    );
  }, []);
  ...
  const handleClickOpen = () => {
    if (
      validateFirstName(reservationData.firstName) &&
      validateLastName(reservationData.lastName) &&
  ...
  const saveReservation = async () => {
    ...
    return (
      <Container
        maxWidth="xl"
        sx={{ mx: 'auto', my: 4, display: 'flex', flexDirection: 'column' }}
      >
            ...
            <Card>
              ...
              <CardContent>
                <Stack spacing={2}>
                  ...
                  <Typography variant="h5">Szczegóły ceny</Typography>
                  <Stack>
                    <Stack direction="row" justifyContent="space-between">
                    ...
                    >
                      ...
                      <Typography variant="h5" color="primary" fontWeight={600}>
                        {reservation.totalPrice + 24 + 4} zł
                      </Typography>
                    </Stack>
                  </Stack>
                  <Button
                  ...
                  >
                    ...
                    <DialogContent>
                      <DialogContentText id="alert-dialog-description">
                        Właśnie dokonałeś rezerwacji. Szczególy zostaną
                        przesłane na podanego maila.
                      </DialogContentText>
                    </DialogContent>
                    <DialogActions>
          ...
          <Grid item xs={1} md={9}>
            {reservation.selectedOptions.map((option) => (
              ...
              >
                  ...
                  >
                    <Stack>
                      ...
                      >
                        ...
                        <Typography color="text.secondary">
                          {reservation.accommondationName} |{' '}
                          {reservation.accommondationAddress}
                        </Typography>
                      </Stack>
                    </Stack>
                  </Stack>
                ...
                <CardMedia
                  ...
                  image={
                    option.room.images.find((image) => image.mainImage === true)
                      .src
                  }
                  alt={
                    option.room.images.find((image) => image.mainImage === true)
            ...
            <Card sx={{ mt: 2 }}>
              <CardContent>
                ...
                >
                  <Stack>
                    <Typography variant="h5">Wpisz swoje dane</Typography>
                    <Typography variant="body1" color="text.secondary">
                      Dane muszą należeć do osoby, która będzie meldować się w
                      danym miejscu
                    </Typography>
                  </Stack>
                  <Stack direction="row" spacing={4}>
                    <CustomTextField
                      ...
                      helperText={firstNameError ? 'Wpisz imię' : ''}
                    ...
                    <CustomTextField
                      ...
                      type="text"
                      error={lastNameError}
                      helperText={lastNameError ? 'Wpisz nazwisko' : ''}
                  ...
                  <Stack direction="row" spacing={4}>
                    <CustomTextField
                      ...
                      type="email"
                      error={emailError}
                      helperText={emailError ? 'Wpisz email' : ''}
                    ...
                    <CustomTextField
                      ...
                      helperText={
                        confirmEmailError ? 'Podane adresy różnią się' : ''
                      }
                      value={reservationData.emailConfirm}
